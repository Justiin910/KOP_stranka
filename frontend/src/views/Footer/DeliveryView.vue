      ...
      <div class="space-y-6">
        ...
        >
          <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">
            {{ $t("pages.delivery.methods_title") }}
          </h2>
        ...
        >
          <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">
            {{ $t("pages.delivery.time_title") }}
          </h2>
          <div class="space-y-3 text-gray-600 dark:text-gray-400">
            <p>
              {{ $t("pages.delivery.time_before") }}
              15:00
              {{ $t("pages.delivery.time_after") }}
            </p>
            <p>{{ $t("pages.delivery.time_weekend") }}</p>
            <p
              class="text-sm bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3"
            >
              <strong>{{ $t("pages.delivery.time_tip_label") }}</strong>
              {{ $t("pages.delivery.time_tip") }}
            </p>
          </div>
        </section>
              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-green-800 dark:text-green-200">
                    {{ $t("pages.delivery.free_description") }}
                  </p>
                </div>
              </div>
            </div>
        ...
        >
          <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">
            {{ $t("pages.delivery.tracking_title") }}
          </h2>
          <div class="space-y-3 text-gray-600 dark:text-gray-400">
        ...
        <!-- Contact -->
        <section
          class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-6"
        >
          <h3 class="font-semibold text-gray-900 dark:text-white mb-2">
            {{ $t("pages.delivery.help_title") }}
          </h3>
