<template>
	<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-950 dark:to-indigo-950 flex items-center justify-center px-4 py-12">
		<div class="w-full max-w-md">
			...
			<div class="text-center mb-8">
				...
				<h1 class="text-3xl font-bold text-gray-900 dark:text-white">Zabudli ste heslo?</h1>
				<p class="text-gray-600 dark:text-gray-400 mt-2 max-w-sm mx-auto">
					{{ !emailSent ? 'Zadajte svoj email a pošleme vám odkaz na obnovenie hesla' : 'Skontrolujte svoj email' }}
				</p>
			</div>
			...
			<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8">
				...
				<div v-else class="text-center">
					...
					<h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Email bol odoslaný!</h3>
						...
						<div class="flex items-start gap-3">
							...
							<div class="text-left">
								<p class="text-sm text-blue-800 dark:text-blue-300">
									Ak email neuvidíte do pár minút, skontrolujte prosím spam folder. Odkaz je platný 24 hodín.
								</p>
							</div>
						</div>
					</div>
					...
					>
						{{ resendCooldown > 0 ? `Poslať znova (${resendCooldown}s)` : 'Neprišiel email? Poslať znova' }}
					</button>
...
export default {
	...
	methods: {
		handleSubmit() {
			...
			// Tu pridáš logiku pre odoslanie emailu
			this.emailSent = true
		},
		resendEmail() {
			console.log('Resending email to:', this.email)
			// Tu pridáš logiku pre znovu odoslanie
